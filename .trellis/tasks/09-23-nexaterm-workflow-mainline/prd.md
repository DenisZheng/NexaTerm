...
| WF-00B 关闭/删除生命周期收尾 | 原有打开、切换、关闭行为稳定 | WF-00A | 关闭/删除 action 迁移完成，A01 有证据；Task 04 剩余范围正式迁出 | `09-23-wf-00b-close-lifecycle`（代码完成 `0079f15` / `0f421fc`，2026-09-23；GUI 冒烟与 A01 ��实窗口证据待做） |
