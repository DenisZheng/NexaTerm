...
> 状态：**已定稿**（2026-09-23 维护者确认 §3 全部按推荐；已回写 `docs/WORKFLOW_SPEC.md` v0.2：WS-E02 / E06 / E08 转已确认，新增 WS-E11–E13，WS-E09 补实现方式）。§4 切片按顺序实施。
...
## 3. 决策（2026-09-23 维护者确认：全部按推荐）

每项给出选项与推荐；推荐基于原需求 §33–§35 与当前代码成本。**已确认列 = 推荐列。**
